        ...
        <div className="drop-down-menu z-4 lg-hidden-h width-full collapse-menu" id="dropDownMenu">
            <div className="vh-full bg-main">
                <div className="width-full bg-main">
                    <Link to={`/`} className={`lg-text-xl width-full hover-text-white text-light ${JwtUser ? "nav-link-purple" : "nav-link"}`} id='lawyer' onClick={() => {toggle(); setToggleHome()}}>{`Accueil`}</Link>
                    ...
                    <Link to="contact" className={`lg-text-xl width-full hover-text-white text-light ${JwtUser ? "nav-link-purple" : "nav-link"}`} id='contact' onClick={toggle}>Contact et informations</Link>
