...
const Lawyer = () => {
    ...
    return (
        <>
            <div className="bg bg-light lg-flex md-flex fade-out" id="page">
                ...
                <div className="lg-width-half lg-height-full md-height-full md-width-half">
                    <img src={vivianePetitAvocatCholet} alt="viviane-petit-avocat-cholet" className="lg-height-full md-hidden-h sm-hidden-h padding-10 switch-image-A" />
                </div>
                <div className="bg-layer sm-padding-top-30 width-full lg-flex lg-item-center padding-10">
                        <div className='lg-width-half'>
                            <h1 className="lg-title-xxl md-title-l sm-text-center sm-underline-1 border-light">Viviane PETIT<br />Avocat</h1>
                            <ul className="fill-light svg-size-3 list-no-style text-xxl">
                                <li className="margin-1 flex li-link hover-svg-breath">
                ...
                <div className="round sm-medium-picture z-3 fix center-fix top-4 md-hidden-h lg-hidden-h"><img src={vivianePetitAvocatCholet} alt="viviane-petit-avocat-cholet" className='md-hidden-h' /></div>
            </div>
            {/* <div className='lg-hidden-h md-hidden-h sm-hidden-h fix height-full top-0 right-0 side-nav width-full overflow-hidden'>
                <Link to="lawyer" className="nav-link lg-text-xl width-full link-text-black hover-text-white" id='lawyer' onClick={(event) => {event.preventDefault(); goTo('lawyer');}}>Viviane PETIT</Link>
                <Link to="lawyer-fields" className="nav-link lg-text-xl width-full link-text-black hover-text-white" id='lawyer-fields' onClick={(event) => {event.preventDefault(); goTo('lawyer-fields')}}>Expertises</Link>
                <Link to="contact" className="nav-link lg-text-xl width-full link-text-black hover-text-white" id='contact' onClick={(event) => {event.preventDefault(); goTo('contact')}}>Contact</Link>
                <Link to="articles" className="nav-link lg-text-xl width-full link-text-black hover-text-white" id='articles' onClick={(event) => {event.preventDefault(); goTo('articles')}}>Articles</Link>
            </div> */}
        </>
    )
}
