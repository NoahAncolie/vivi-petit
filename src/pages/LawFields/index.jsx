...
const LawFields = () => {
    return (
        <div className="bg bg-main fade-out lg-padding-10 sm-padding-1 md-padding-1" id="page">
            ...
            <section>
                <br />
                <h3 className="border-blue border-left-2 title">L’honoraire forfaitaire </h3>
                <p className="text-justify">Après une première analyse de votre dossier et en fonction des objectifs à atteindre et du résultat escompté, l’avocat pourra définir une rémunération globale pour l’ensemble des étapes du dossier.
                ...
                <br /><h3 className="border-blue border-left-2 title">L’honoraire au temps passé  </h3>
                <p className="text-justify">Ce type d’honoraires peut être proposé par l’avocat lorsqu’il est impossible d’évaluer exactement le nombre d’<b>heures de travail</b> nécessaires pour le traitement de votre dossier.
                ...
                <br /><h3 className="border-blue border-left-2 title">L’honoraire complémentaire de résultat </h3>
                <p className="text-justify">La convention d’honoraires peut prévoir, en plus de l’honoraire de base (forfaitaire ou au temps passé), un honoraire complémentaire de résultat, rémunérant l’avocat suivant un <b>pourcentage du résultat obtenu ou du service rendu</b>.
                ...
                <br /><h3 className="border-blue border-left-2 title">Le contrat d’abonnement  </h3>
                <p className="text-justify">L’avocat peut prévoir avec son client des <b>honoraires forfaitaires</b> pour une période déterminée et reconductible (<b>mensuel</b>, <b>trimestriel</b>, <b>annuel</b>…).
            ...
            <section>
                ...
                <br /><h3 className="border-blue border-left-2 title">L’aide juridictionnelle</h3>
                <p className="text-justify">Ce système d’aide permet aux personnes physiques, dont les ressources sont insuffisantes pour faire valoir leurs droits en Justice, de bénéficier d’une <b>aide juridictionnelle totale</b> ou <b>partielle</b>.
                    ...
                    En cas d’aide juridictionnelle partielle, l’avocat devra établir une convention d’honoraires avec le client, soumise à l’appréciation du Bâtonnier.
                    Si vous disposez d’un contrat d’assurance de protection juridique je vous remercie de me l’indiquer lors de notre premier rendez-vous.
