...
const Home = ({ goTo }) => {
    ...
    return (
        <div className="bg bg-main lg-flex md-flex fade-out" id="page">
            ...
            <div className="bg-layer sm-padding-top-30 md-padding-top-2 width-full lg-flex lg-item-center lg-padding-10">
                <div className='lg-width-half'>
                    ...
                    <ul className="fill-light svg-size-3 list-no-style lg-text-xxl">
                        ...
                        <br />
                        <li className="margin-1 flex li-link fill-black hover-svg-breath">
                            <a href="https://consultation.avocat.fr/avocat-cholet/viviane-petit-42295.html" className='cta-link md-text-xl'>Prendre rendez-vous</a>
                        </li>
                    </ul>
                </div>
            </div>
